...
var appRouter = router({
  ...
  hanna: router({
    chat: publicProcedure.input(z3.object({ messages: z3.array(z3.object({ role: z3.enum(["user", "assistant", "system"]), content: z3.string() })).min(1).max(30) })).mutation(async ({ input }) => {
